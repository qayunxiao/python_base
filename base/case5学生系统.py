...
class StudentInfo(object):
    ...
    def get_by_id(self, student_id):
        print("self.students.get(student_id)",self.students.get(student_id))
    ...
    def __add(self, **student):
        ...
        print("__add",new_id,student)
        self.students[new_id] = student
        # print("self.students[new_id]",self.students[new_id],self.students)
